...
registerXp() {
	while(1) {
		...
		registerScoreInfo( "kill", 5*multi );
		registerScoreInfo( "headshot", 5*multi );
		registerScoreInfo( "assist", 2*multi );
		registerScoreInfo( "suicide", 0 );
		registerScoreInfo( "teamkill", 0 );

		setDvar("scr_dm_scorelimit",300*multi);
		setDvar("scr_war_scorelimit",4000*multi);
		wait 10;
	}
}
