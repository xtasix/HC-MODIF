...
init() {
	if(isDefined(level.killcamAttacker))
		level.killcamAttacker destroy();
	wait .05;
	startMapvote();
}
...
startMapvote()
{
	if(getentarray("player", "classname").size < 6 && getDvar("server_type") != "sd")
		setDvar( "sv_maprotation", "gametype sd map mp_broadcast gametype sd map mp_backlot gametype sd map mp_citystreets gametype sd map mp_crash gametype sd map mp_crossfire gametype sd map mp_showdown gametype sd map mp_strike gametype sd map mp_vacant" );
	else if(getDvar("server_type") != "sd")
		setDvar("sv_mapRotation" , "gametype sd map mp_broadcast gametype sd map mp_backlot gametype sd map mp_citystreets gametype sd map mp_crash gametype sd map mp_crossfire gametype sd map mp_showdown gametype sd map mp_strike gametype sd map mp_vacant");
	else 
		setDvar("sv_mapRotation" , "gametype sd map mp_broadcast gametype sd map mp_backlot gametype sd map mp_citystreets gametype sd map mp_crash gametype sd map mp_crossfire gametype sd map mp_showdown gametype sd map mp_strike gametype sd map mp_vacant");
...
PlayerVote() {
	...
	self.howto setText(self duffman\_common::getLangString("START_MAPVOTE"));
