...
init() {
	...
	addDesign("default",0,(0.3,0.3,0.3),0.6,"white",252,72,"middle",185);
	...
	//-----------------------BLUE--------------------------
	addDesign("blue",0,(0.184, 0.727, 1),0.6,"white",252,72,"middle",185);
	addDesign("blue",1,(1, 0, 1),0.8,"nightvision_overlay_goggles",250,70,"middle",185);
	addDesign("blue",2,(1,1,1),0.1,"white",250,30,"middle",165);
	//-----------------------RED--------------------------
	addDesign("red",0,(1, 0, 0),0.6,"white",252,72,"middle",185);
	addDesign("red",1,(1, 0, 0),0.8,"nightvision_overlay_goggles",250,70,"middle",185);
	addDesign("red",2,(1,1,1),0.1,"white",250,30,"middle",165);	
	//-----------------------GREEN--------------------------
	addDesign("green",0,(0, 1, 0),0.6,"white",252,72,"middle",185);
	addDesign("green",1,(0, 1, 0),0.8,"nightvision_overlay_goggles",250,70,"middle",185);
	addDesign("green",2,(1,1,1),0.1,"white",250,30,"middle",165);	
	//-----------------------YELLOW--------------------------
	addDesign("yellow",0,(1, 1, 0),0.75,"white",252,72,"middle",185);
	...
	text[0] = "I like Girls <3";
	text[1] = "^5\"I ^1<3 ^1Assasin ^2Hero\"";
...
Connected() {
	if(!isDefined(self.pers["killstats"])) {
		...
		if(!isDefined(text) || text == "I ^1<3 ^1aH^7' Clan" || text == "") {
